...
public class CheapestFlightsWithinKStops {
    ...
    public static void main(String[] args) {
        ...
        CheapestFlightsWithinKStops myObj = new CheapestFlightsWithinKStops();
        System.out.println(myObj.findCheapestPrice(n, flights, src, dest, K));
